...
QString apiKey = "AIzaSyAvCSptRtTAUKyj9vcSslotxOSoqava4Lk";
...
{
    QString url = QString("http://maps.google.com/maps/geo?q=%1&key=%2&output=json&oe=utf8").arg(address).arg(apiKey);
